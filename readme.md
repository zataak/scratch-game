...
#### Assumptions ####
- There is no limit on the betting amount
- Betting amount is always a whole number and greater than 0
- Bonus symbol generation is not mandatory - (hardcoded to have 75% chances)
- There can be at most one Bonus symbol
- reward_multiplier is always a whole number and greater than 0
- Final reward is always a positive whole number

#### TODOs #### 
- Improve on domain modelling
- Delegate more responsibilities to Probability & Symbol classes
- More validations
- More test coverage
- More java docs & code comments
- Add some integration tests
- Reword error messages where needed
